...
- Optional endpoint input/output contracts and a generic linear workflow planner/executor for chaining compatible runnable tools while preserving single-tool recommendations, strengthened with catalog metadata during auto-import.
