...
class BaseToolOutput(BaseModel):
    ...
    result_path: Optional[str] = Field(
        default=None,
        description="Backward compatibility: primary result path"
    )
    
    # Metadata
    metadata_text: Optional[str] = Field(
        default=None,
        description="Human-readable metadata about the result"
    )
    ...
    notes: Optional[str] = Field(
        default=None,
        description="Additional notes or context for user"
    )
...
class ImageToolInput(BaseToolInput):
    ...
    description: Optional[str] = Field(
        default=None,
        description="Optional context or notes from agent about the task"
    )
