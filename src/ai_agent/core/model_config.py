"""Frontend-agnostic model configuration lookup."""
...
def get_available_models() -> Dict[str, Dict[str, Optional[str]]]:
    """
    Get available models from config.yaml for selection.
...
def get_model_config(model_display_name: str) -> Dict[str, Optional[str]]:
    ...
    Returns:
        Dictionary with 'name', 'base_url', 'provider', and 'api_key_env' keys.
    """
